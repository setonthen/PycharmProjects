...
def main():
    ...
    spanish_english={}
    for eng,espn in english_spanish.items():
        spanish_english[espn]=eng
    print('Dictionary contents: ')
    spanish = sorted(english_spanish.keys())
    separator = ', '
    print(separator.join(spanish))
    while True:
        ...
        if command == "W":
            ...
            spanish_english[word_spanish]=word_english
            print('Dictionary contents: ')
            spanish = sorted(english_spanish.keys())
            separator = ', '
            print(separator.join(spanish))
            ...
            if word in english_spanish:
                del spanish_english[english_spanish[word]]
            if word in english_spanish:
            ...
            for wd, trans in sorted(spanish_english.items()):
                print(wd,trans,sep=' ')
            print()
